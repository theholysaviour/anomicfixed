...
if not game:IsLoaded() then
	...
	notLoaded.Text = 'Infinite Yield Anomic is waiting for the game to load'
	game.Loaded:Wait()
	notLoaded:Destroy()
end
...
Title.TextSize = 18
Title.Text = "Infinite Yield Anomic v"..ver
...
Logo.Image = "rbxassetid://6649737071"
...
Credits.Text = "Yoder // taco // tealingg // lolmanurfunny"
...
function saves()
	if writefileExploit() then
		if pcall(function() readfile("IY_ANO.iy") end) then
			if readfile("IY_ANO.iy") ~= nil then
				local success, response = pcall(function()
					local json = game:GetService("HttpService"):JSONDecode(readfile("IY_ANO.iy"))
				...
				if not success then
					...
					writefileCooldown("IY_ANO.iy", defaults)
					wait()
					saves()
				end
			else
			...
			if pcall(function() readfile("IY_ANO.iy") end) then
				...
				Directions.Font = Enum.Font.SourceSans
				Directions.TextSize = 14
				Directions.Text = "There was an error while saving your file. Either your exploit does not support savefile or it has simply bugged."
				Directions.TextColor3 = Color3.new(1, 1, 1)
				Directions.TextWrapped = true
...
function updatesaves()
	if nosaves == false and writefileExploit() then
		...
		writefileCooldown("IY_ANO.iy", game:GetService("HttpService"):JSONEncode(update))
	end
end
...
CMDs = {}
CMDs[#CMDs + 1] = {NAME = 'silence / johnwick', DESC = 'Completely suppress held firearm [Toggle] *Will not work on shotguns*'}
CMDs[#CMDs + 1] = {NAME = 'console', DESC = 'Loads old Roblox console'}
CMDs[#CMDs + 1] = {NAME = 'innocent', DESC = 'Hehe :trol'}
CMDs[#CMDs + 1] = {NAME = 'loopheal / god', DESC = 'OMG ABIN ABOOZ'}
CMDs[#CMDs + 1] = {NAME = 'hide', DESC = 'Yeah'}
CMDs[#CMDs + 1] = {NAME = 'unhide', DESC = 'Mhm'}
CMDs[#CMDs + 1] = {NAME = 'unloopheal / ungod', DESC = 'No more ABIN ABOOZ'}
CMDs[#CMDs + 1] = {NAME = 'rainbowtool', DESC = 'Funny tool'}
CMDs[#CMDs + 1] = {NAME = 'rainbowcar', DESC = 'Funny car'}
CMDs[#CMDs + 1] = {NAME = 'nocliptool / nct', DESC = 'Noclip tool'}
CMDs[#CMDs + 1] = {NAME = 'pickcars', DESC = 'Unlock cars within 35 studs.'}
CMDs[#CMDs + 1] = {NAME = 'alarm', DESC = 'Alarm undriven cars within 35 studs'}
CMDs[#CMDs + 1] = {NAME = 'torque / fastercar', DESC = 'Bypasses speed cap on cars'}
CMDs[#CMDs + 1] = {NAME = 'carhop / boing', DESC = 'Experience 10Gs of acceleration on the Y axis'}
CMDs[#CMDs + 1] = {NAME = 'FWD / frontwheeldrive', DESC = 'Front wheels spin'}
CMDs[#CMDs + 1] = {NAME = 'RWD / rearwheeldrive', DESC = 'Rear wheels spin (may lead to instability off road)'}
CMDs[#CMDs + 1] = {NAME = 'bigcarhop / bigboing', DESC = 'Experience 30Gs of acceleration on the Y axis'}
...
CMDs[#CMDs + 1] = {NAME = 'breakloops', DESC = 'Disables command loops'}
...
CMDs[#CMDs + 1] = {NAME = 'speedometer / hud', DESC = 'Enables the speedometer of current vehicle'}
...
CMDs[#CMDs + 1] = {NAME = 's250', DESC = 'Subtracts 250 cash'}
CMDs[#CMDs + 1] = {NAME = '500k', DESC = 'Resets cash to 500k'}
...
CMDs[#CMDs + 1] = {NAME = 'prismatic', DESC = 'Car prismatic mod'}
CMDs[#CMDs + 1] = {NAME = 'suspension', DESC = 'Car suspension mod'}
CMDs[#CMDs + 1] = {NAME = 'tpdetect / antitp', DESC = 'Detects teleportation.'}
...
CMDs[#CMDs + 1] = {NAME = 'nodrop', DESC = 'Disables item drop of currently held item'} --Anoex
...
CMDs[#CMDs + 1] = {NAME = 'nocrash / bypass', DESC = 'Disables void anticheat'}
...
CMDs[#CMDs + 1] = {NAME = 'anonymous', DESC = 'Makes your name near impossible to find (REVERTS WHEN DIED)'}
CMDs[#CMDs + 1] = {NAME = 'sus / amogus / amongus [R] [G] [B]', DESC = 'Makes you amogus'}
...
CMDs[#CMDs + 1] = {NAME = 'boost / go', DESC = 'Gotta go fast'}
CMDs[#CMDs + 1] = {NAME = 'brake / stop', DESC = 'Come to a complete stop in a moving vehicle'}
CMDs[#CMDs + 1] = {NAME = 'backboost / back', DESC = 'Gotta go fast but in reverse'}
...
CMDs[#CMDs + 1] = {NAME = 'rcar', DESC = 'Deletes vehicle and crashes passengers'}
CMDs[#CMDs + 1] = {NAME = 'getcar', DESC = 'Boonk gangs a random car'}
CMDs[#CMDs + 1] = {NAME = 'clean', DESC = 'Deletes broken cars'}
CMDs[#CMDs + 1] = {NAME = 'owner', DESC = 'Notifies you the owner of the car that you are sitting in'}
CMDs[#CMDs + 1] = {NAME = 'wanted / outlaw [plr]', DESC = 'Makes the target an outlaw (MAY KILL YOU, THEY MUST BE IN A CAR)'}
CMDs[#CMDs + 1] = {NAME = 'unlockcars', DESC = 'Unlocks all current and newly spawned vehicles (run this once)'}
CMDs[#CMDs + 1] = {NAME = 'break', DESC = 'Breaks held gun/car (still tradable)'}
...
CMDs[#CMDs + 1] = {NAME = 'skycar / skydivecar [Height] [true/false]', DESC = 'Makes current vehicle freefall'}
...
CMDs[#CMDs + 1] = {NAME = 'fchat [plr]', DESC = 'Allows you to chat as another player'}
...
CMDs[#CMDs + 1] = {NAME = 'homerun / hr [plr]', DESC = 'Make player a experience 300+ Gs of acceleration'}
CMDs[#CMDs + 1] = {NAME = 'carbomb / explode [plr]', DESC = 'Explodes a player (YOU NEED A SHOTGUN AND CAR)'}
CMDs[#CMDs + 1] = {NAME = 'smite / airstrike [plr]', DESC = 'Smites a player (YOU NEED A SHOTGUN AND CAR)'}
CMDs[#CMDs + 1] = {NAME = 'kill / obliterate [plr] (TOOL)', DESC = 'Kills a player (YOU NEED A TOOL)'}
CMDs[#CMDs + 1] = {NAME = 'hotwheels / hw / spinattack / sa / toss [plr] (TOOL)', DESC = 'Kills a player then makes then spin like a hotwheels car (YOU NEED A TOOL)'}
CMDs[#CMDs + 1] = {NAME = 'heaven [plr] (TOOL)', DESC = 'Hits someone with the fucking force of god (YOU NEED A TOOL)'}
CMDs[#CMDs + 1] = {NAME = 'decimate [plr] (TOOL)', DESC = 'Fucking deletes the target (May need to use multiple times, takes a while.) (YOU NEED A TOOL)'}
CMDs[#CMDs + 1] = {NAME = 'eat (TOOL)', DESC = 'Eats your held (or a random) tool. (YOU NEED A TOOL)'}
CMDs[#CMDs + 1] = {NAME = 'gunmod', DESC = 'Mods all guns.'}
CMDs[#CMDs + 1] = {NAME = 'skidcheck', DESC = 'Checks the server for any skids.'}
CMDs[#CMDs + 1] = {NAME = 'crash / bsod [plr] (TOOL)', DESC = 'Crashes a player'}
...
CMDs[#CMDs + 1] = {NAME = 'infstam', DESC = 'Infinite Stamina'}
CMDs[#CMDs + 1] = {NAME = 'nostam', DESC = 'Finite stamina'}
CMDs[#CMDs + 1] = {NAME = 'reset', DESC = 'Resets your character normally'}
CMDs[#CMDs + 1] = {NAME = 'respawn', DESC = 'Respawns you'}
CMDs[#CMDs + 1] = {NAME = 'carhop / boing', DESC = 'Jump in current vehicle.'}
CMDs[#CMDs + 1] = {NAME = 'nocar / harmlesscars', DESC = 'No damage or sitting from getting hit by cars'}
CMDs[#CMDs + 1] = {NAME = 'refresh / re', DESC = 'Respawns and brings you back to the same position'}
CMDs[#CMDs + 1] = {NAME = 'ejectpassengers/ep/kickpassengers/kp [plr]', DESC = 'Kicks the passengers of the car in which the player is driving.'}
CMDs[#CMDs + 1] = {NAME = 'invisible / invis', DESC = 'Makes you invisible but you cannot use guns. Can use cars.'}
...
CMDs[#CMDs + 1] = {NAME = 'toolaura', DESC = 'Delete nearest tool'}
CMDs[#CMDs + 1] = {NAME = 'hataura', DESC = 'Delete nearest hat'}
CMDs[#CMDs + 1] = {NAME = 'nohats / deletehats / rhats / makeawish [plr]', DESC = 'Deletes hats'}
CMDs[#CMDs + 1] = {NAME = 'notool [plr]', DESC = 'Deletes tool'}
...
CMDs[#CMDs + 1] = {NAME = 'modf', DESC = 'Mods fuel of held car'} --Anoex
CMDs[#CMDs + 1] = {NAME = 'modh', DESC = 'Mods health of held car'} --Anoex
...
CMDs[#CMDs + 1] = {NAME = 'incognito / antiesp', DESC = 'Become incognito to admins'}
CMDs[#CMDs + 1] = {NAME = 'donate [plr] [amount]', DESC = 'Sends a player an amount of cash'}
...
CMDs[#CMDs + 1] = {NAME = 'realcar / wheelspin', DESC = 'Hold X to have the car function like a normal car'}
...
SpecialPlayerCases = {
	...
	["mayor"] = function(speaker,args)
	    return{game:GetService("ReplicatedStorage").CurrentMayor.Value}
	end,
	["crafter"] = function(speaker,args)
	    local returns = {}
	    for _,plr in next, Players:GetPlayers() do
	        
	    end
	end,
	["advanced"] = function(speaker, args)
	    local returns = {}
	    for _,plr in next, Players:GetPlayers() do
	        
	    end
	end,
	["government"] = function(speaker, args)
...
function addPlugin(name)
	if name:lower() == 'plugin file name' or name:lower() == 'iy_ano.iy' or name == 'iy_ano' then
...
addcmd('silence',{'johnwick'},function(args, speaker)
for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
    if v:IsA("Tool") then
        if v.Handle:FindFirstChild("ReloadSound") then
            if v.Handle:FindFirstChild("GunEmpty") then
                v.Handle.Shot.Name = "" v.Handle.GunEmpty.Name = "Shot"
                v.Main.MuzzleFlash.ImageLabel:Destroy()
                v.Main.Smoke:Destroy()
                print("Suppressed "..v.Name)
                else
                v.Handle.Shot.Name = "GunEmpty" v.Handle[""].Name = "Shot"
                print("Un-Suppressed "..v.Name)
            end
            else
            warn(v.Name.." is not a gun.")
        end
    end
end
end)

addcmd('RWD',{'rearwheeldrive'},function(args, speaker)
local player = game.Players.LocalPlayer
local mouse = player:GetMouse()

local bodyfuck=Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent.RR.Wheel)

mouse.KeyDown:connect(function(key)
if key:byte() == 119 then
bodyfuck.force=Vector3.new(0,0,-6000)
bodyfuck.location =Vector3.new(0,1,0)
end end)
...
local bodyfuck=Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent.RL.Wheel)
...
addcmd('FWD',{'frontwheeldrive'},function(args, speaker)
local player = game.Players.LocalPlayer
local mouse = player:GetMouse()

local bodyfuck=Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent.FL.Wheel)
...
local bodyfuck=Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent.FR.Wheel)
...
addcmd('rcar',{},function(args, speaker)
	...
	notify('Successfully deleted '..vehicleModel.Name.." ($"..itemListModule[vehicleModel.Name].Price..")")
end)

addcmd('clean',{},function(args, speaker)
    local carorigin = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
    local found = false
    for _,car in next, workspace.PlayerVehicles:GetChildren() do
        if car:FindFirstChild('VehicleSeat') and not car:FindFirstChild('VehicleSeat'):FindFirstChild('SeatWeld') and car:FindFirstChild("VehicleSeat").Damage.Value < 1 and not found then
            local seat = car:FindFirstChild('VehicleSeat')
            execCmd('unlockcars')
            repeat wait(.15)
            if not speaker.Character.Humanoid.Sit then execCmd('jump') end
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = car:FindFirstChild('VehicleSeat').CFrame
            until seat:FindFirstChild('SeatWeld') or not car:FindFirstChild('VehicleSeat')
            execCmd('rcar')
            found = true
            wait(.2)
        end
    end
    game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = carorigin
    if not found then if found == false then notify('No available cars found') end end
end)

addcmd('getcar',{},function(args, speaker)
    local carorigin = game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame
    local found = false
    for _,car in next, workspace.PlayerVehicles:GetChildren() do
        if car:FindFirstChild('VehicleSeat') and not car:FindFirstChild('VehicleSeat'):FindFirstChild('SeatWeld') and not found then
            local seat = car:FindFirstChild('VehicleSeat')
            execCmd('unlockcars')
            repeat wait(.15)
            if not speaker.Character.Humanoid.Sit then execCmd('jump') end
            ...
            until seat:FindFirstChild('SeatWeld') or not car:FindFirstChild('VehicleSeat')
            wait(.3)
            car:SetPrimaryPartCFrame(carorigin * CFrame.new(0, 5, 0))
            wait(.1)
            game.Players.LocalPlayer.Character.HumanoidRootPart.CFrame = car:FindFirstChild('VehicleSeat').CFrame
            found = true
        end
...
addcmd('owner',{},function(args, speaker)
    local seat = game.Players.LocalPlayer.Character.Humanoid.SeatPart
    if not seat then
        notify("Error","You are not sitting in a car, you dumbass.")
        return
    end
	local vehicleModel = seat.Parent
	notify("The owner of this "..vehicleModel.Name.." is "..vehicleModel.Properties.Owner.Value.Name)
end)

addcmd('wanted',{'outlaw'},function(args, speaker)
    local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
    	local seat = Players[v].Character.Humanoid.SeatPart
        if not seat then
            notify("Error",v.." is not sitting in a car, you dumbass.")
            return
        end
    	local vehicleModel = seat.Parent
    	for _,ww in next, workspace.Roads.Walkways:GetChildren() do
    	    for _ = 1,10 do
                game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").HitCar:FireServer(vehicleModel,55,ww)
            end
    	end
        notify("Successfully attempted to make "..v.." wanted.")
    end
end)

addcmd('skycar',{'skydivecar'},function(args, speaker)
    local height = args[1]
    local seat = game.Players.LocalPlayer.Character.Humanoid.SeatPart
    local vehicleModel = seat.Parent
    repeat
    ...
    vehicleModel:MoveTo(Vector3.new(vehicleModel.PrimaryPart.Position.X, vehicleModel.PrimaryPart.Position.Y + height, vehicleModel.PrimaryPart.Position.Z))

    if args[2] == "true" then
        repeat wait()
        game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").EnterVehicle:FireServer(vehicleModel,"FrontLeft")
        until speaker.Character.Humanoid.SeatPart == seat
    end
end)

addcmd('unlockcars',{''},function(args, speaker)
	notify('Unlocked C=')
    while wait(2) do
...
addcmd('speedometer',{'hud'},function(args, speaker)
	notify('Enabled speedometer')
    if game.CoreGui:FindFirstChild('Speedometer') then
    game.CoreGui:FindFirstChild('Speedometer'):Destroy()
    end
local Speedometer = Instance.new("ScreenGui")
local Speed = Instance.new("TextLabel")

Speedometer.Name = "Speedometer"
Speedometer.Parent = game.CoreGui
Speedometer.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

Speed.Name = "Speed"
Speed.Parent = Speedometer
Speed.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
Speed.BackgroundTransparency = 1.000
Speed.Position = UDim2.new(0.579770565, 0, 0.961330652, 0)
Speed.Size = UDim2.new(0, 146, 0, 19)
Speed.Font = Enum.Font.Highway
Speed.Text = "Speed: 0"
Speed.TextColor3 = Color3.fromRGB(0, 0, 0)
Speed.TextSize = 19.000
Speed.TextXAlignment = "Left"
Speed.TextYAlignment = "Top"
...
Speed.InputBegan:Connect(
	function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
			dragging = true
			dragStart = input.Position
			startPos = Speed.Position
...
repeat wait()
Speed.Text = ("Speed: "..math.floor(game.Players.LocalPlayer.Character.HumanoidRootPart.Velocity.Magnitude))
until game.Players.LocalPlayer.Character.Humanoid.Health <= 0 or Speed == nil
if game.Players.LocalPlayer.Character.Humanoid.Health <= 0 then
Speedometer:Destroy()
end
end)

addcmd('breakloops',{},function(args, speaker)
	lastBreakTime = tick()
end)
...
addcmd('vfly',{'vehiclefly'},function(args, speaker)
	...
	wait()
	sFLY(true)
	game.Players.InteractionSystem.Parent = game:GetService("Players").LocalPlayer.PlayerGui["_L.Handler"]
end)
...
addcmd('vflyspeed',{'vflysp','vehicleflyspeed','vehicleflysp'},function(args, speaker)
	...
	if isNumber(speed) then
		...
		game:GetService("Players").LocalPlayer.PlayerGui["_L.Handler"].InteractionSystem.Parent = game.Players
		execCmd('unvfly')
		execCmd('vfly')
		game.Players.InteractionSystem.Parent = game:GetService("Players").LocalPlayer.PlayerGui["_L.Handler"]
	end
...
addcmd('tpdetect',{'antitp'},function(args, speaker)
if AC then return end
getgenv().AC = true
notify('Activated Teleport Detector')
while wait(.05) do
    for i,v in pairs(game.Players:GetChildren()) do
        local t = tick()
        if v ~= game.Players.LocalPlayer and v.Character ~= nil and not v.Character.HumanoidRootPart.Anchored and v.Character:FindFirstChildWhichIsA('Humanoid').Health > 0 and not v.Character.Humanoid.SeatPart and not v.Character:FindFirstChild("Arrested") then
        local old = v.Character.HumanoidRootPart.Position
        wait(.05)
        local mag = (old - v.Character.HumanoidRootPart.Position).Magnitude
        if mag >= 10 then
            notify(v.Name.." : "..math.floor(mag).." studs since last indexed position.  "..(tick() - t))
end
end
end
end
...
addcmd('prismatic',{},function(args, speaker)
    	local height = -1.5
	if args[1] and isNumber(args[1]) then
		height = args[1]
	end
local con = game.Players.LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Constraints")
    for i,v in pairs(con:GetChildren()) do
        if v:IsA('PrismaticConstraint') then
        v.LowerLimit = height * -1
        end
    end
end)

addcmd('suspension',{},function(args, speaker)
    	local height = 2.3
	if args[1] and isNumber(args[1]) then
		height = args[1]
	end
...
addcmd('pickcars',{},function(args, speaker)
for i,v in pairs(workspace.PlayerVehicles:GetChildren()) do
    local mag = (v:FindFirstChild('Engine').Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    if mag <= 35 then
        game.Players.LocalPlayer.Backpack:FindFirstChildWhichIsA("Tool").Parent = game.Players.LocalPlayer.Character
        game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").ToolEvent:FireServer("PickCar", v, game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA('Tool'))
        game.Players.LocalPlayer.Character:FindFirstChildWhichIsA('Tool').Parent = game.Players.LocalPlayer.Backpack
    end
end
end)

addcmd('alarm',{},function(args, speaker)
for i,v in pairs(workspace.PlayerVehicles:GetChildren()) do
    local mag = (v:FindFirstChild('Engine').Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
    if mag <= 35 then
        game.Players.LocalPlayer.Backpack:FindFirstChildWhichIsA("Tool").Parent = game.Players.LocalPlayer.Character
        game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").ToolEvent:FireServer("TriggerCarAlarm", v, game:GetService("Players").LocalPlayer.Character:FindFirstChildWhichIsA('Tool'))
        game.Players.LocalPlayer.Character:FindFirstChildWhichIsA('Tool').Parent = game.Players.LocalPlayer.Backpack
    end
end
end)
...
addcmd('boost',{'go'},function(args, speaker)
local player = game.Players.LocalPlayer
local mouse = player:GetMouse()
local bodyfuck=Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Engine")) --nigga
bodyfuck.force=Vector3.new(0,0,-100000)
wait()
bodyfuck:Destroy()
end)

addcmd('backboost',{'back'},function(args, speaker)
local player = game.Players.LocalPlayer
local mouse = player:GetMouse()
...
bodyfuck.force=Vector3.new(0,0,200000)
wait()
bodyfuck:Destroy()
end)
...
addcmd('brake',{'stop'},function(args, speaker)
local bodyvelo = Instance.new("BodyVelocity", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart)
local ang = Instance.new("BodyAngularVelocity", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Engine"))
bodyvelo.MaxForce = Vector3.new(9e9, 9e9, 9e9)
bodyvelo.Velocity = Vector3.new(0,0,0)
bodyvelo.P = math.huge
ang.MaxTorque = Vector3.new(9e9, 9e9, 9e9)
...
addcmd('innocent',{},function(args, speaker)
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("hide")
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("unhide")
end)
...
addcmd('bypass',{},function(args, speaker)
    repeat wait() until speaker.Character.HumanoidRootPart.Anchored == false
    local time = tick()
    for i, v in next, getconnections(game:GetService("Players").LocalPlayer.Character.DescendantAdded) do
        v:Disable()
	end
    ...
    if success then
        notify('Successfully bypassed anticheat\n(took '..((tick()-time))..' seconds)')
    else
        notify('Error', err)
    end
end)
...
addcmd('invisible',{'invis'},function(args, speaker)
    execCmd('bypass')
    local originalposition = speaker.Character.HumanoidRootPart.CFrame
    speaker.Character.HumanoidRootPart.CFrame = CFrame.new(2114.14697, -83.3234253, -1407.88184)
    local workspace = game.Workspace
    local lp = game.Players.LocalPlayer
    local fuckmeintheass = Instance.new("SelectionBox")
    fuckmeintheass.Adornee = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart
    fuckmeintheass.Parent = game:GetService("Players").LocalPlayer.Character.HumanoidRootPart
    fuckmeintheass.LineThickness = "0"
    game:GetService("Players").LocalPlayer.Character.UpperTorso.Waist:Destroy()
    game:GetService("Players").LocalPlayer.Character.LowerTorso:Destroy()
    wait()
    speaker.Character.HumanoidRootPart.CFrame = originalposition
    wait()
...
addcmd('ejectpassengers',{'ep','kickpassengers','kp'},function(args, speaker)
    local players = getPlayer(args[1], speaker)
    for _,a in next, players do
        if Players[a].Character.Humanoid.SeatPart ~= nil then
            local car = Players[a].Character.Humanoid.SeatPart.Parent
            if car:IsA('Model') and car:FindFirstChild('Engine') then
                game:GetService("ReplicatedStorage")["_CS.Events"].EjectPassengers:FireServer(car)
                notify("Ejected passengers of "..a.."'s "..car.Name)
            else
                car = Players[a].Character.Humanoid.SeatPart.Parent.Parent
                if car:IsA('Model') and car:FindFirstChild('Engine') then
                    game:GetService("ReplicatedStorage")["_CS.Events"].EjectPassengers:FireServer(car)
                    notify("Ejected passengers of "..a.."'s "..car.Name)
                else
                    notify("Error","Try using the command on the driver of the car.")
                end
            end
        else
            notify("Error",a.." is not sitting in a car, you dumbass.")
        end
    end
end)
...
addcmd('break',{},function(args, speaker)
	for _,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
		if v:IsA("Tool") then
			for i,c in pairs(v:GetDescendants()) do
                if c.Name == "Info" then
                    c:Destroy()
                    notify('Prevented Car Placement and Storing')
                elseif c.Name == "MainGunScript" then
                    c:Destroy()
                    notify('Prevented Gun Shooting and Reloading')
                end
			end
		end
	end
...
addcmd('anonymous',{},function(args, speaker)
    speaker.Character.Head.PlayerDisplay.PlayerName:Destroy()
    speaker.Character.HumanoidRootPart.NameTag:Destroy()
    speaker.Character.HumanoidRootPart.LocalPlayerBG:Destroy()
    local originalskin = speaker.Character.Head.Color
    game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Color",Color3.new(0,0,0),"SkinColor")
    execCmd('nohats')
    execCmd('naked')
    spawn(function()
        speaker.Character.Humanoid.Changed:Connect(function(p)
    		if p == "Health" then
...
addcmd('sus',{'amogus','amongus'},function(args, speaker)
    local origin = speaker.Character.HumanoidRootPart.CFrame
    speaker.Character.HumanoidRootPart.CFrame = CFrame.new(2114.14697, -83.3234253, -1407.88184)
    if tonumber(args[1]) and tonumber(args[2]) and tonumber(args[3]) then
        game:GetService("ReplicatedStorage")["_CS.Events"].EquipAvatarItem:FireServer("Color",Color3.fromRGB(args[1],args[2],args[3]),"SkinColor")
    else
    ...
    getRoot(speaker.Character).CFrame = origin
    wait(.15)
    notify(string.lower(tostring(speaker.Character.Head.BrickColor)).." is the impostor")
end)
...
addcmd('nodrop',{},function(args, speaker)
	for _,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
		if v:IsA("Tool") then
			for i,c in pairs(v:GetDescendants()) do
...
addcmd('modf',{},function(args, speaker)
	for _,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
		if v:IsA("Tool") then
			for i,c in pairs(v:GetDescendants()) do
                if c.Name == "Fuel" then
...
addcmd('modh',{},function(args, speaker)
	for _,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
		if v:IsA("Tool") then
			for i,c in pairs(v:GetDescendants()) do
                if c.Name == "Damage" then
                 c:Destroy()
                     c:Destroy()
                 notify('Success!')
                    end
...
addcmd('infstam',{''},function(args, speaker)
for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
    if v:IsA("LocalScript") and v.Name ~= "KeyDrawer" and v.Name ~= "Animate" and v.Name ~= "AnimationHandler" then
        v.Disabled = true
    end
...
addcmd('nostam',{''},function(args, speaker)
for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
    if v:IsA("LocalScript") and v.Name ~= "KeyDrawer" and v.Name ~= "Animate" and v.Name ~= "AnimationHandler" then
        v.Disabled = false
       notify('Finite stamina') 
    end
end
end)
...
notify('Infinite Stamina','You now have infinite stamina')
end)
...
addcmd('speed',{'ws','walkspeed'},function(args, speaker)
	if args[2] then
		...
		if isNumber(args[2] or 13) then
			speaker.Character:FindFirstChildOfClass('Humanoid').WalkSpeed = args[2] or 13
		end
	else
		if isNumber(args[1] or 13) then
			speaker.Character:FindFirstChildOfClass('Humanoid').WalkSpeed = args[1] or 13
		end
	end
end)
...
addcmd('loopheal',{'god'},function(args, speaker)
if god == true then 
    god = false
end
god = true
repeat wait()
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("heal")
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("heal")
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("heal")
until god == false
end)

addcmd('unloopheal',{'ungod'},function(args, speaker)
god = false
end)

addcmd('rainbowtool',{},function(args, speaker)
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("rainbowtool")
end)

addcmd('rainbowcar',{},function(args, speaker)
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("rainbowcar")
end)
...
addcmd('unhide',{},function(args, speaker)
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("unhide")
end)

addcmd('nocliptool',{'nct'},function(args, speaker)
if game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events"):FindFirstChild('Validate') then
    game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events"):FindFirstChild('Validate'):Destroy()
    end
game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").CMD:FireServer("noclippingtool")
end)
...
addcmd('fchat',{},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players)do
		speaker.Character:FindFirstChildOfClass('Humanoid').Sit = true
		headSit = game:GetService("RunService").Heartbeat:Connect(function()
			if Players[v].Character ~= nil and getRoot(Players[v].Character) and getRoot(speaker.Character) then
				if Players:FindFirstChild(Players[v].Name) and speaker.Character:FindFirstChildOfClass('Humanoid').Sit == true then
					getRoot(speaker.Character).CFrame = getRoot(Players[v].Character).CFrame * CFrame.Angles(0,math.rad(0),0)* CFrame.new(0,1.4,0)
				else
					headSit:Disconnect()
				end
			end
...
addcmd('nocar',{'harmlesscars'},function(args, speaker)
game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.TouchInterest:Destroy()
notify('You will no longer take damage from vehicles')
end)
...
addcmd('fullbright',{'fb','fullbrightness'},function(args, speaker)
    ...
    game:GetService("Lighting").BlackFade.Enabled = false
    game:GetService("Lighting").Atmosphere:Destroy()
    game:GetService("Lighting").DefaultSky:Destroy()
    notify('Brightened your day ;)')
end)
...
addcmd('deletehats',{'nohats','rhats','makeawish'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
		if Players[v] == speaker then
		    ...
		    for _,hat in next, Players[v].Character:GetChildren() do
		        if hat:IsA('Accessory') or hat:IsA('Hat') then
    		        local originarea = speaker.Character.HumanoidRootPart.CFrame
    		        for i = 1,2 do
        		        speaker.Character.HumanoidRootPart.CFrame = Players[v].Character.HumanoidRootPart.CFrame * CFrame.Angles(0, 0, math.rad(180))
        		        game:GetService("ReplicatedStorage")["_CS.Events"].Dropper:FireServer(hat,"PickUp")
        		        wait()
    		        end
    		        speaker.Character.HumanoidRootPart.CFrame = originarea
		        end
		    end
		end
	end
...
addcmd('notool',{},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
		if Players[v] == speaker then
		    if speaker.Character then
		    ...
		    for _,x in next, Players[v].Character:GetChildren() do
		        if x:IsA('Tool') then
    		        local originarea = speaker.Character.HumanoidRootPart.CFrame
    		        for i = 1,1 do
        		        speaker.Character.HumanoidRootPart.CFrame = Players[v].Character.HumanoidRootPart.CFrame * CFrame.Angles(0, 0, math.rad(180))
        		        game:GetService("ReplicatedStorage")["_CS.Events"].Dropper:FireServer(x,"PickUp")
        		        wait()
    		        end
    		        speaker.Character.HumanoidRootPart.CFrame = originarea
		        end
...
addcmd('toolaura',{},function(args, speaker)
    for i,v in pairs(game.Players:GetChildren()) do
        if v ~= game.Players.LocalPlayer and game.Players.LocalPlayer.Character and v.Character then
            local mag = (v.Character:FindFirstChild("HumanoidRootPart").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
            if mag <= 20 then
            game:GetService("ReplicatedStorage")["_CS.Events"].Dropper:FireServer(v.Character:FindFirstChildWhichIsA('Tool'),"PickUp")
            end
        end
    end
end)

addcmd('hataura',{},function(args, speaker)
    for i,v in pairs(game.Players:GetChildren()) do
        if v ~= game.Players.LocalPlayer and game.Players.LocalPlayer.Character and v.Character then
            local mag = (v.Character:FindFirstChild("HumanoidRootPart").Position - game.Players.LocalPlayer.Character.HumanoidRootPart.Position).Magnitude
            if mag <= 20 then
            game:GetService("ReplicatedStorage")["_CS.Events"].Dropper:FireServer(v.Character:FindFirstChildWhichIsA('Accessory'),"PickUp")
            end
        end
    end
end)
...
function aaa(speaker,target)
	if tools(speaker) then
	    execCmd('nolegs')
		local char1 = speaker.Character
		...
		wait()
		hum:Destroy()
		workspace.CurrentCamera.CameraSubject = char1
		newHum.DisplayDistanceType = "None"
		local tool = speaker:FindFirstChildOfClass("Backpack"):FindFirstChildOfClass("Tool") or speaker.Character:FindFirstChildOfClass("Tool")
		tool.Parent = char1
		game:GetService("Players").LocalPlayer.Character:FindFirstChildOfClass('Tool'):FindFirstChild("ToolModel"):Destroy()
		...
		until (tool.Parent ~= char1 or not hrp or not hrp2 or not hrp.Parent or not hrp2.Parent or n > 250) and n > 2
		speaker.Character.HumanoidRootPart.CFrame = CFrame.new(Vector3.new(0, 10000, 0))
	end
end

addcmd('kill',{'obliterate'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
    	aaa(speaker,Players[v])
    end
end)

addcmd('kick',{'spamtools'},function(args, speaker)
		    for i = 1, 25 do
                execCmd('nct')
            end
                wait(1)
...
addcmd('hotwheels',{'hw','spinattack','sa','toss'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
        execCmd('nolegs')
        execCmd('anonymous')
    	...
    	local hotwheelss = Instance.new("BodyAngularVelocity")
    	hotwheelss.Name = "Hotwheels"
    	hotwheelss.Parent = speaker.Character.HumanoidRootPart
    	hotwheelss.MaxTorque = Vector3.new(0, math.huge, 0)
    	hotwheelss.AngularVelocity = Vector3.new(0,250,0)
    	wait()
    	aaa(speaker,Players[v])
        execCmd('nobgui')
        execCmd('respawn')
...
addcmd('heaven',{},function(args, speaker)
    local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
	    for i, v in next, getconnections(game:GetService("Players").LocalPlayer.Character.DescendantAdded) do
            v:Disable()
        ...
        execCmd('nolegs')
        execCmd('anonymous')
	    local heavenforce = Instance.new("BodyThrust")
        heavenforce.Parent = speaker.Character.HumanoidRootPart
        heavenforce.Force = Vector3.new(0,25000,0)
    	wait()
    	aaa(speaker,Players[v])
        execCmd('nobgui')
        execCmd('respawn')
...
addcmd('decimate',{},function(args, speaker)
    local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
	    for i, v in next, getconnections(game:GetService("Players").LocalPlayer.Character.DescendantAdded) do
            v:Disable()
	    ...
	    local heavenforce = Instance.new("BodyThrust")
        heavenforce.Parent = speaker.Character.HumanoidRootPart
        heavenforce.Force = Vector3.new(0,9e9,0)
    	wait()
    	aaa(speaker,Players[v])
        execCmd('nobgui')
        execCmd('respawn')
...
addcmd('eat',{},function(args, speaker)
    local done = false
    for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do
        if v:IsA("Tool") then
            v.Name = "Medi Kit"
            game:GetService("ReplicatedStorage")["_CS.Events"].ToolEvent:FireServer("Heal",game.Players.LocalPlayer.Character,game.Players.LocalPlayer.Character["Medi Kit"])
            done = true
        end
    end
end)

addcmd('conceal',{},function(args, speaker)
	local gun = speaker.Character:FindFirstChildOfClass("Tool")
	if gun.Name == "Sawed Off" or gun.Name:find('Shotgun') then
	    gun.ToolModel:Destroy()
	    gun.Parent = getRoot(speaker.Character)
	end
end)

addcmd('equipnct',{},function(args, speaker)
...
addcmd('gunmod',{},function(args, speaker)
    local itemList = require(game.ReplicatedStorage.Client.ItemList)
    local guns = {}
    for i, v in pairs(itemList) do
        if v.DataType == "RangedWeapon" then
            table.insert(guns, tostring(i))
        end 
    end
    spawn(function()
        while wait(.5) do
            for k, x in pairs(guns) do
                itemList[x].Range = math.huge
                itemList[x].Firerate = math.huge
                                if not itemList[x].Firemode == "Shot" then
                    itemList[x].Firemode = "Auto"
                end
            end
        end
    end)
...
addcmd('skidcheck',{},function(args, speaker)
    local skiddetect = false
    for _,q in next, Players:GetPlayers() do
        if not q.Character.Head.PlayerDisplay:FindFirstChild('PlayerName') and not speaker:IsFriendsWith(q.UserId) and q ~= speaker then
            notify("Anomic X'er",q.Name.." is a certified skid")
            skiddetect = true
        end
    end
    if skiddetect == false then
        notify("Clean Server","No skids detected")
    end
end)

addcmd('torque',{'fastercar'},function(args, speaker)
local player = game.Players.LocalPlayer
local mouse = player:GetMouse()
local bodyfuck=Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Engine"))
mouse.KeyDown:connect(function(key)
...
addcmd('carhop',{'boing'},function(args, speaker)
local bodyfuck = Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Engine")) --nigga
local bodyvelo = Instance.new("BodyAngularVelocity", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Engine"))
bodyfuck.Force = Vector3.new(0,150000,0)
bodyvelo.MaxTorque = Vector3.new(9e9, 9e9, 9e9)
bodyvelo.AngularVelocity = Vector3.new(0,0,0)
wait()
bodyfuck:Destroy()
wait(1)
bodyvelo:Destroy()
...
addcmd('bigcarhop',{'bigboing'},function(args, speaker)
local bodyfuck = Instance.new("BodyThrust", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Engine")) --nigga
local bodyvelo = Instance.new("BodyAngularVelocity", game:GetService("Players").LocalPlayer.Character.Humanoid.SeatPart.Parent:FindFirstChild("Engine"))
bodyfuck.Force = Vector3.new(0,300000,0)
bodyvelo.MaxTorque = Vector3.new(9e9, 9e9, 9e9)
bodyvelo.AngularVelocity = Vector3.new(0,0,0)
wait()
bodyfuck:Destroy()
...
addcmd('homerun',{'hr'},function(args, speaker)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
		homerun(speaker,Players[v])
		execCmd('reset')
	end
end)

addcmd('carbomb',{'explode'},function(args, speaker)
    if speaker.Character:FindFirstChild("Sawed Off") or speaker.Character:FindFirstChild("Shotgun") or speaker.Character:FindFirstChild("Riot Shotgun") or speaker.Character:FindFirstChild("Bullpup Shotgun") then
        local gun = speaker.Character:FindFirstChildOfClass('Tool')
        local seat = speaker.Character.Humanoid.SeatPart
        local car = seat.Parent
        local originPos = getRoot(speaker.Character).CFrame
        local parttohit = car.Body:FindFirstChild('Paint')
        if car and car:FindFirstChild('VehicleSeat') then
            car:SetPrimaryPartCFrame(workspace.Camera.Focus)
            wait(.1) 
            speaker.Character.Humanoid.Sit = false
            wait(.1)
            for i = 1, 4 do
            speaker.Character.HumanoidRootPart.CFrame = originPos
            end
            wait()
            local mag = (parttohit.Position - speaker.Character.HumanoidRootPart.Position).Magnitude
            if mag < 30 then return end
            for i = 1, 300 do
                game.ReplicatedStorage['_CS.Events'].WeaponServer:FireServer("Vehicle", parttohit, gun.Name)
            end
            end
        end
end)

addcmd('smite',{'airstrike'},function(args, speaker)
    if speaker.Character:FindFirstChild("Sawed Off") or speaker.Character:FindFirstChild("Shotgun") or speaker.Character:FindFirstChild("Riot Shotgun") or speaker.Character:FindFirstChild("Bullpup Shotgun") and speaker.Character.Humanoid.SeatPart then
        local gun = speaker.Character:FindFirstChildOfClass('Tool')
        local seat = speaker.Character.Humanoid.SeatPart
        local car = seat.Parent
        local players = getPlayer(args[1], speaker)
        ...
        local originPos = getRoot(speaker.Character).CFrame
        local parttohit = car.Body:FindFirstChild('Paint')
        if car and car:FindFirstChild('VehicleSeat') and target and target.Character and target.Character:FindFirstChild('Humanoid') then
            car:SetPrimaryPartCFrame(target.Character.HumanoidRootPart.CFrame * CFrame.new(0,1000,0))
            wait()
            speaker.Character.Humanoid.Sit = false
            wait(.1)
            speaker.Character.HumanoidRootPart.CFrame = originPos
...
function homerun(speaker,target) --HOMERUN
	if tools(speaker) then
	    for i, v in next, getconnections(game:GetService("Players").LocalPlayer.Character.DescendantAdded) do
            v:Disable()
        end
	    ...
	    Spin.AngularVelocity = Vector3.new(0,30000,0)
		local n = 0
		repeat
			wait(.1)
			n = n + 1
...
function kill(speaker,target,fast)
	if tools(speaker) then
		if target ~= nil then
			...
			repeat
				wait()
				hrp.CFrame = CFrame.new(9999999, workspace.FallenPartsDestroyHeight + 5,9999999)
...
addcmd('handlekill', {''}, function(args, speaker)
...
addcmd('crash',{'bsod'},function(args, speaker)
    wait(.1)
	local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
	    execCmd('bypass')
...
addcmd('antiesp',{'incognito'},function(args, speaker)
    local char = game.Players.LocalPlayer.Character
    char.Parent = nil
    char.HumanoidRootPart:Destroy()
    char.Parent = workspace
    execCmd('anonymous')
    notify('You are now hidden to admin esp')
end)

addcmd('donate',{},function(args, speaker)
    local players = getPlayer(args[1], speaker)
	for i,v in pairs(players) do
		game:GetService("ReplicatedStorage"):FindFirstChild("_CS.Events").GiveMoneyToPlr:FireServer(v,args[2])
	end
end)
...
minimizeHolder()
notify('You are running the latest version: '..ver)
execCmd('bypass')
